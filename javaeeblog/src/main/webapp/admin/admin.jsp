...
<body>
	...
	<div class="container" id="main">
		...
		<div id="header">
			<div>
				<h2><a href="../login.html">MyBlog-管理</a></h2>
				...
				<div class="list-group-item">						
						<input type="text"  class="sort" value="${s}"   disabled="disabled" style="border:0px;"  >
						 <div class="r_div">							
						 <button class="btn btn-default" onclick="edit_sort(this,'${s}')">&nbsp;<span class="glyphicon glyphicon-pencil" style="color:#5bc0de" >编辑</span>&nbsp;</button>
						 <button class="btn btn-default" onclick="delet_sort(this,'${s}')">&nbsp;<span class="glyphicon glyphicon-trash" style="color:#d9534f" >删除</span>&nbsp;</button>
						 </div>										 
				</div>							
				</c:forEach>
				</div>
				...
				<div class="list-group-item">						
						<input type="text" class="tags"  value="${t.tag}"  disabled="disabled"  style="border:0px">
						 <div class="r_div">	
						 <button class="btn btn-default" onclick="edit_tag(this,'${t.tag}')" >&nbsp;<span class="glyphicon glyphicon-pencil" style="color:#5bc0de" >编辑</span>&nbsp;</button>
						 <button class="btn btn-default" onclick="delet_tag(this,'${t.tag}')">&nbsp;<span class="glyphicon glyphicon-trash" style="color:#d9534f" >删除</span>&nbsp;</button>
						 </div>										 
				</div>							
				</c:forEach>
